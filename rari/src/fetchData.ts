...
import {
  ...
  export function getGovernanceEntity(): Governance {
    ...
    if (governance == null) {
      ...
      governance.votes = BIGINT_ZERO;
      governance.uselessVotes = BIGINT_ZERO;
      governance.uselessDelegations = BIGINT_ZERO;
      governance.uselessTransfers = BIGINT_ZERO;
    }
  ...
  export function getDelegation(id: String,createIfNotFound: boolean = true,): Delegation {
