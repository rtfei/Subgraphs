...
export class GovernorAlpha1__getActionsResult {
...
export class GovernorAlpha1__getReceiptResultValue0Struct extends ethereum.Tuple {
...
export class GovernorAlpha1__proposalsResult {
  value0: BigInt;
  value1: Address;
  value2: BigInt;
  value3: BigInt;
...
export class GovernorAlpha1 extends ethereum.SmartContract {
  static bind(address: Address): GovernorAlpha1 {
    return new GovernorAlpha1("GovernorAlpha1", address);
  }
  ...
  getActions(proposalId: BigInt): GovernorAlpha1__getActionsResult {
    let result = super.call(
      "getActions",
    ...
    return new GovernorAlpha1__getActionsResult(
  ...
  try_getActions(
    proposalId: BigInt
  ): ethereum.CallResult<GovernorAlpha1__getActionsResult> {
    let result = super.tryCall(
      "getActions",
      "getActions(uint256):(address[],uint256[],string[],bytes[])",
      [ethereum.Value.fromUnsignedBigInt(proposalId)]
    ...
    return ethereum.CallResult.fromValue(
      new GovernorAlpha1__getActionsResult(
  ...
  getReceipt(
    proposalId: BigInt,
    voter: Address
  ): GovernorAlpha1__getReceiptResultValue0Struct {
    let result = super.call(
      "getReceipt",
    ...
    return changetype<GovernorAlpha1__getReceiptResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getReceipt(
    proposalId: BigInt,
    voter: Address
  ): ethereum.CallResult<GovernorAlpha1__getReceiptResultValue0Struct> {
    let result = super.tryCall(
      "getReceipt",
      "getReceipt(uint256,address):((bool,bool,uint96))",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<GovernorAlpha1__getReceiptResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
  ...
  proposals(param0: BigInt): GovernorAlpha1__proposalsResult {
    let result = super.call(
      "proposals",
    ...
    return new GovernorAlpha1__proposalsResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_proposals(
    param0: BigInt
  ): ethereum.CallResult<GovernorAlpha1__proposalsResult> {
    let result = super.tryCall(
      "proposals",
      "proposals(uint256):(uint256,address,uint256,uint256,uint256,uint256,uint256,bool,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GovernorAlpha1__proposalsResult(
        value[0].toBigInt(),
        value[1].toAddress(),
        value[2].toBigInt(),
        value[3].toBigInt(),
