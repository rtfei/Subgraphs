...
export class Governor extends ethereum.SmartContract {
  ...
  ndx(): Address {
    let result = super.call("ndx", "ndx():(address)", []);

    return result[0].toAddress();
  }

  try_ndx(): ethereum.CallResult<Address> {
    let result = super.tryCall("ndx", "ndx():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  permanentVotingPeriod(): BigInt {
    let result = super.call(
      "permanentVotingPeriod",
      "permanentVotingPeriod():(uint256)",
      []
    );
  ...
  try_permanentVotingPeriod(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "permanentVotingPeriod",
      "permanentVotingPeriod():(uint256)",
      []
  ...
  setVotingPeriodAfter(): BigInt {
    let result = super.call(
      "setVotingPeriodAfter",
      "setVotingPeriodAfter():(uint256)",
      []
    );
  ...
  try_setVotingPeriodAfter(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "setVotingPeriodAfter",
      "setVotingPeriodAfter():(uint256)",
      []
...
export class ConstructorCall__Inputs {
  ...
  get setVotingPeriodAfter_(): BigInt {
...
export class SetPermanentVotingPeriodCall extends ethereum.Call {
  get inputs(): SetPermanentVotingPeriodCall__Inputs {
    return new SetPermanentVotingPeriodCall__Inputs(this);
  }

  get outputs(): SetPermanentVotingPeriodCall__Outputs {
    return new SetPermanentVotingPeriodCall__Outputs(this);
  }
}

export class SetPermanentVotingPeriodCall__Inputs {
  _call: SetPermanentVotingPeriodCall;

  constructor(call: SetPermanentVotingPeriodCall) {
    this._call = call;
  }
}

export class SetPermanentVotingPeriodCall__Outputs {
  _call: SetPermanentVotingPeriodCall;
