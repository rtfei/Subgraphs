...
export class ChangedName extends ethereum.Event {
  get params(): ChangedName__Params {
    return new ChangedName__Params(this);
  }
}

export class ChangedName__Params {
  _event: ChangedName;

  constructor(event: ChangedName) {
    this._event = event;
  }
...
export class ChangedSymbol extends ethereum.Event {
  get params(): ChangedSymbol__Params {
    return new ChangedSymbol__Params(this);
  }
}

export class ChangedSymbol__Params {
  _event: ChangedSymbol;

  constructor(event: ChangedSymbol) {
    this._event = event;
  }

  get oldSybmol(): string {
    return this._event.parameters[0].value.toString();
  }

  get newSybmol(): string {
    return this._event.parameters[1].value.toString();
  }
}
...
export class ChangeSymbolCall extends ethereum.Call {
  get inputs(): ChangeSymbolCall__Inputs {
    return new ChangeSymbolCall__Inputs(this);
  }

  get outputs(): ChangeSymbolCall__Outputs {
    return new ChangeSymbolCall__Outputs(this);
  }
}

export class ChangeSymbolCall__Inputs {
  _call: ChangeSymbolCall;

  constructor(call: ChangeSymbolCall) {
    this._call = call;
  }
...
export class ChangeSymbolCall__Outputs {
  _call: ChangeSymbolCall;
...
export class UnpauseTransferCall extends ethereum.Call {
  get inputs(): UnpauseTransferCall__Inputs {
    return new UnpauseTransferCall__Inputs(this);
  }

  get outputs(): UnpauseTransferCall__Outputs {
    return new UnpauseTransferCall__Outputs(this);
  }
}

export class UnpauseTransferCall__Inputs {
  _call: UnpauseTransferCall;

  constructor(call: UnpauseTransferCall) {
    this._call = call;
  }
}

export class UnpauseTransferCall__Outputs {
  _call: UnpauseTransferCall;
