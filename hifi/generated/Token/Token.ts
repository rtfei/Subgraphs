...
export class Swap__Params {
  ...
  get mftAmount(): BigInt {
    return this._event.parameters[1].value.toBigInt();
  }

  get hifiAmount(): BigInt {
    return this._event.parameters[2].value.toBigInt();
  }
}
...
export class Token extends ethereum.SmartContract {
  ...
  mft(): Address {
    let result = super.call("mft", "mft():(address)", []);

    return result[0].toAddress();
  }

  try_mft(): ethereum.CallResult<Address> {
    let result = super.tryCall("mft", "mft():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  swapRatio(): i32 {
    let result = super.call("swapRatio", "swapRatio():(uint8)", []);

    return result[0].toI32();
  }

  try_swapRatio(): ethereum.CallResult<i32> {
    let result = super.tryCall("swapRatio", "swapRatio():(uint8)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
