...
export class Governor__receiptsResult {
  value0: boolean;
  value1: boolean;
  value2: BigInt;
...
export class Governor extends ethereum.SmartContract {
  ...
  receipts(param0: BigInt, param1: Address): Governor__receiptsResult {
    let result = super.call(
      "receipts",
    ...
    return new Governor__receiptsResult(
      result[0].toBoolean(),
      result[1].toBoolean(),
      result[2].toBigInt()
    );
  ...
  try_receipts(
    param0: BigInt,
    param1: Address
  ): ethereum.CallResult<Governor__receiptsResult> {
    let result = super.tryCall(
      "receipts",
      "receipts(uint256,address):(bool,bool,uint96)",
      [
...
export class AcceptTimelockAdminCall extends ethereum.Call {
  get inputs(): AcceptTimelockAdminCall__Inputs {
    return new AcceptTimelockAdminCall__Inputs(this);
  }

  get outputs(): AcceptTimelockAdminCall__Outputs {
    return new AcceptTimelockAdminCall__Outputs(this);
  }
}

export class AcceptTimelockAdminCall__Inputs {
  _call: AcceptTimelockAdminCall;

  constructor(call: AcceptTimelockAdminCall) {
    this._call = call;
  }
}

export class AcceptTimelockAdminCall__Outputs {
  _call: AcceptTimelockAdminCall;
