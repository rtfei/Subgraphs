...
export class Token extends ethereum.SmartContract {
  ...
  mintingRestrictedBefore(): BigInt {
    let result = super.call(
      "mintingRestrictedBefore",
      "mintingRestrictedBefore():(uint256)",
      []
    );
  ...
  try_mintingRestrictedBefore(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "mintingRestrictedBefore",
      "mintingRestrictedBefore():(uint256)",
      []
...
export class ConstructorCall__Inputs {
  ...
  get mintingRestrictedBefore_(): BigInt {
