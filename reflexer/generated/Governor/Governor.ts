...
export class NewTimelock extends ethereum.Event {
  get params(): NewTimelock__Params {
    return new NewTimelock__Params(this);
  }
}

export class NewTimelock__Params {
  _event: NewTimelock;

  constructor(event: NewTimelock) {
    this._event = event;
  }
...
export class Governor extends ethereum.SmartContract {
  ...
  MAX_QUORUM_VOTES(): BigInt {
    let result = super.call(
      "MAX_QUORUM_VOTES",
      "MAX_QUORUM_VOTES():(uint256)",
      []
    );
  ...
  try_MAX_QUORUM_VOTES(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "MAX_QUORUM_VOTES",
      "MAX_QUORUM_VOTES():(uint256)",
      []
  ...
  MIN_QUORUM_VOTES(): BigInt {
    let result = super.call(
      "MIN_QUORUM_VOTES",
      "MIN_QUORUM_VOTES():(uint256)",
      []
    );
  ...
  try_MIN_QUORUM_VOTES(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "MIN_QUORUM_VOTES",
      "MIN_QUORUM_VOTES():(uint256)",
      []
  ...
  propose(
    ...
    let result = super.call(
      ...
      [
        ...
        ethereum.Value.fromStringArray(param2),
...
export class _setQuorumVotesCall extends ethereum.Call {
  get inputs(): _setQuorumVotesCall__Inputs {
    return new _setQuorumVotesCall__Inputs(this);
  }

  get outputs(): _setQuorumVotesCall__Outputs {
    return new _setQuorumVotesCall__Outputs(this);
  }
}

export class _setQuorumVotesCall__Inputs {
  _call: _setQuorumVotesCall;

  constructor(call: _setQuorumVotesCall) {
    this._call = call;
  }
...
export class _setQuorumVotesCall__Outputs {
  _call: _setQuorumVotesCall;
...
export class _setTimelockCall extends ethereum.Call {
  get inputs(): _setTimelockCall__Inputs {
    return new _setTimelockCall__Inputs(this);
  }

  get outputs(): _setTimelockCall__Outputs {
    return new _setTimelockCall__Outputs(this);
  }
}

export class _setTimelockCall__Inputs {
  _call: _setTimelockCall;

  constructor(call: _setTimelockCall) {
    this._call = call;
  }
...
export class _setTimelockCall__Outputs {
  _call: _setTimelockCall;
