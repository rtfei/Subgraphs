...
export class GovernorAlpha extends ethereum.SmartContract {
  ...
  tribe(): Address {
    let result = super.call("tribe", "tribe():(address)", []);

    return result[0].toAddress();
  }

  try_tribe(): ethereum.CallResult<Address> {
    let result = super.tryCall("tribe", "tribe():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
...
export class __transferGuardianCall extends ethereum.Call {
  get inputs(): __transferGuardianCall__Inputs {
    return new __transferGuardianCall__Inputs(this);
  }

  get outputs(): __transferGuardianCall__Outputs {
    return new __transferGuardianCall__Outputs(this);
  }
}

export class __transferGuardianCall__Inputs {
  _call: __transferGuardianCall;

  constructor(call: __transferGuardianCall) {
    this._call = call;
  }
...
export class __transferGuardianCall__Outputs {
  _call: __transferGuardianCall;
